...
start_epoch = 0
batch_size = 32
weight_path = 'model/base/1000.pth'
...
for i in range(3):
    key = 'to_hrms' + str(i)
    weight[key+'.weight'] = torch.zeros(8, 32, 5, 5)  # weight['to_hrms.weight']
    weight[key+'.bias'] = torch.zeros(8)  # weight['to_hrms.bias']
...
def update(model):
    ...
    for name, p in model.named_parameters():
        if name in ['to_hrms0.weight', 'to_hrms0.bias', 'to_hrms1.weight', 'to_hrms1.bias',
                    'to_hrms2.weight', 'to_hrms2.bias']:
