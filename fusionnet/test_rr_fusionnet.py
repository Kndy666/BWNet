...
def test(file_path):
    ...
    ms, ms_hp, lms, pan, pan_hp, gt = load_h5py_hp(file_path)
    B = gt.shape[0]
    ...
    for k in range(B):
        with torch.no_grad():
            ...
            save_name = os.path.join(
                "D:/Study/pansharpening_new_data/02-Test-toolbox-for-traditional-and-DL(Matlab)/2_DL_Result/WV3_Reduced/BWNet/results",
...
if __name__ == '__main__':
    ...
    file_path = 'D:/Study/pansharpening_new_data/02-Test-toolbox-for-traditional-and-DL(Matlab)/1_TestData/PanCollection/test_wv3_multiExm1.h5'
    test(file_path)
